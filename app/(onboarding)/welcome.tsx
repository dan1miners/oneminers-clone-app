...
const features = [
  {
    ...
    description:
      "Track miners in real-time, monitor hashrate, temperature, pool data, and mining performance at a glance",
    icon: "stats-chart",
    details: [
  ...
  },
  {
    ...
    description:
      "Stay informed with real-time updates on balance, mining progress, and all invoices for electricity and fees",
    icon: "wallet",
    details: [
  ...
  },
  {
    ...
    description:
      "Our intelligent system selects the most profitable mining pools automatically based on real-time market data",
    icon: "rocket",
    details: [
  ...
  },
  {
    ...
    description:
      "Manage your entire mining operation from anywhere with our dedicated mobile application",
    icon: "phone-portrait",
    details: [
      "Full remote control",
      "Push notifications",
  ...
  },
  {
    ...
    title: "Marketplace",
    description:
      "Set up custom or automated pricing for new miners and servers, tailored for both new and existing clients",
    icon: "cart",
    details: [
...
export default function OnboardingScreen() {
  ...
  const renderItem = ({ item }: { item: (typeof features)[0] }) => {
    return (
      <View
        className="items-center pt-5 pb-10"
        style={{ width: width - 40, marginHorizontal: 20 }}
      >
        <View className="w-[100px] h-[100px] rounded-full justify-center items-center bg-om-accent-75 mb-8">
          <Ionicons
        ...
        <View className="flex-row justify-around w-full px-4 mt-2">
          <View className="items-center flex-1">
            <Ionicons name="analytics" size={20} color={APP_COLORS.accent} />
            <Text className="text-xs font-semibold text-gray-500 mt-1.5">
              Real-time
            </Text>
          </View>
          <View className="items-center flex-1">
            <Ionicons name="flash" size={20} color={APP_COLORS.accent} />
            <Text className="text-xs font-semibold text-gray-500 mt-1.5">
              Optimized
            </Text>
          </View>
  ...
  return (
    ...
    >
      ...
      <View className="flex-row justify-between items-center px-6 pb-[30px] pt-2.5 border-t border-gray-200">
        {currentIndex > 0 && (
          <TouchableOpacity
            className="w-[50px] h-[50px] rounded-full bg-gray-100 justify-center items-center opacity-80"
            onPress={handlePrev}
          >
            <Ionicons
              name="chevron-back"
        ...
        <TouchableOpacity
          className="w-[50px] h-[50px] rounded-full bg-om-accent justify-center items-center"
          onPress={handleNext}
        >
          <Ionicons
            name={
