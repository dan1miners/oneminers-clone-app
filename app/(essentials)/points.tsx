  ...
  const redeemItems = [
    {
      ...
      pointsRequired: 1000,
      subtitle:
        "Exchange 1000 points for $5 worth of BTC (rate at time of redemption).",
      icon: "logo-bitcoin",
    },
    {
      id: "r2",
      ...
      pointsRequired: 2000,
      subtitle:
        "Exchange 2000 points for $10 worth of BTC (rate at time of redemption).",
      icon: "gift-outline",
    },
    {
      id: "r3",
      ...
      pointsRequired: 5000,
      subtitle:
        "Exchange 5000 points for $25 worth of BTC (rate at time of redemption).",
      icon: "wallet-outline",
    },
  ];
      ...
      <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-gray-100 dark:border-slate-700">
          ...
          <View className="mt-4 bg-gray-50 dark:bg-slate-950 rounded-2xl p-4 border border-gray-100 dark:border-slate-700">
            ...
            <Text className="text-2xl font-extrabold text-black dark:text-slate-100 mt-1">
              {totalCoins}
            </Text>
            <Text className="text-xs text-gray-400 dark:text-slate-500 mt-2">
              Redemptions are paid in BTC based on the current rate at the time
              of redemption.
            </Text>
          </View>
        </View>
        ...
        {/* ✅ Redeem section */}
        <View className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-gray-100 dark:border-slate-700 mt-4">
          <View className="flex-row items-center justify-between mb-3">
            <Text className="text-base font-bold text-black dark:text-slate-100">
              Redeem rewards
            </Text>
            <View className="bg-om-accent/15 px-3 py-1 rounded-full">
          ...
          {redeemItems.map((item) => {
            ...
            return (
              <View
                key={item.id}
                className="border border-gray-100 dark:border-slate-700 rounded-2xl p-4 mb-3 bg-white dark:bg-slate-900"
              >
                <View className="flex-row items-center">
                  ...
                  >
                    <Text
                      className={`text-[10px] font-semibold ${eligible ? "text-black dark:text-slate-100" : "text-gray-400 dark:text-slate-500"}`}
                    >
                ...
                <Text className="text-xs text-gray-500 dark:text-slate-400 mt-3 leading-5">
                  {item.subtitle}
                </Text>
                ...
                <TouchableOpacity
                  ...
                  className={`mt-4 rounded-xl py-3 items-center ${
                    eligible ? "bg-om-accent" : "bg-gray-100 dark:bg-slate-800"
                  }`}
                  activeOpacity={0.9}
                  onPress={() => {
                ...
                >
                  <Text
                    className={`text-sm font-bold ${eligible ? "text-black dark:text-slate-100" : "text-gray-400 dark:text-slate-500"}`}
                  >
                    Redeem
                  </Text>
                </TouchableOpacity>
          ...
          <Text className="text-[11px] text-gray-400 dark:text-slate-500 mt-2 leading-4">
            Note: Rewards, conversion rates, and availability may change. BTC
            value is calculated at redemption time.
          </Text>
        </View>
        ...
        <View className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-gray-100 dark:border-slate-700 mt-4">
          ...
          <View className="flex-row mb-3">
            <View className="w-8 h-8 rounded-lg bg-om-accent/20 items-center justify-center mr-3">
              <Ionicons
            ...
            <Text className="text-sm text-gray-600 dark:text-slate-300 leading-5 flex-1">
              Check in once per day to earn points. A 7-day streak gives
              consistent rewards.
            </Text>
          </View>
          ...
          <View className="flex-row">
            ...
            <Text className="text-sm text-gray-600 dark:text-slate-300 leading-5 flex-1">
              Rewards and values may change based on promotions and account
              status.
            </Text>
          </View>
        </View>
        ...
        {/* Recent activity */}
        <View className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-gray-100 dark:border-slate-700 mt-4 mb-8">
          <Text className="text-base font-bold text-black dark:text-slate-100 mb-3">
            Recent activity
          </Text>
          ...
          {recent.map((item) => (
            <View
              key={item.id}
              className="flex-row items-center py-3 border-b border-gray-100 dark:border-slate-700"
            >
              <View className="w-9 h-9 rounded-xl bg-gray-50 dark:bg-slate-950 items-center justify-center mr-3">
                <Ionicons
